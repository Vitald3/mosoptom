                    ...
                    <form action="{{ $action }}" method="post" novalidate>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <label>Символьное обозначение (только английские буквы)</label>
                                        <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" placeholder="Символьное обозначение" value="{{ old('slug', $slug) }}" required/>
                                        @error('slug')
                                        <span class="invalid-feedback" role="alert" style="display: block"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
